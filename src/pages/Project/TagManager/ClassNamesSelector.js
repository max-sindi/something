...
const classGroupsExist = [
  ...
  { name: 'Typography', classNames: ['fz', 'font-weight', 'black', 'white', 'pre-wrap', 'text-no-wrap', 'bold', 'text-wrap', 'text-align', 'ff-primary', 'ff-secondary', 'color-white', 'text-transform', 'lh']},
